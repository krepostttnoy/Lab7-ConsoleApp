...
import org.example.clientUtils.readers.IReadManager

/**
 * Класс для создания объекта [Vehicle] с данными, введёнными пользователем через консоль.
 * Реализует интерфейс [IVehicleManager], используя [org.example.clientUtils.readers.IReadManager] для чтения данных.
 *
