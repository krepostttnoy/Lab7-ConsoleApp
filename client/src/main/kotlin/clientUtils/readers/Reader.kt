...
class Reader(
     ...
     * Проверяет, что введённое значение соответствует одному из значений [baseClasses.FuelType].
     *
     * @return Введённый тип топлива в виде значения [baseClasses.FuelType].
